...
Failed Mobile Numbers : <font color="red">${mobileFails}</font>

<form action="${pageContext.request.contextPath}/sendSms"> 
<table>
<tr>
<td>Mobile Number</td><td>:</td><td><input type="text" name="mobile"/></td><td>Enter multiple numbers with comma(,) separater</td>
</tr>
<tr>
